...
**Applied AI Engineer | ML Systems for Healthcare & Finance**  
Python | PyTorch | FastAPI | Node.js | Time-Series & Medical AI  
...
**Domain:** Pediatric Health Monitoring, Digital Health, Financial Forecasting  
...
- UNet + ResNet34 + Attention/ASPP for laparoscopic lesions  
- Outputs Persian diagnostic reports  

**ASQ Digital Health Platform** – Child Development Monitoring  
- Node.js backend, SQL, real-time communication  
